...
exports.run = function(client, message) {
	...
	if (cevap === "YAZI-TURA:__YAZI__**") {
		...
		.setThumbnail("https://www.organikgurmem.com/wp-content/uploads/2018/04/1-TL.jpg")
		...
		.setColor(0xf4b942)
		.setDescription(cevap)
		.setThumbnail("https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTnn3x7RozeFGc6bqHfLhubO7Ej77TZVwErSYh0A1O25hG09VVHHg")
