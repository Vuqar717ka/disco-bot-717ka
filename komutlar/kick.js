...
exports.run = (client, message, args) => {
  ...
  if (message.mentions.users.size < 1) return message.reply('Kime kick atyon yazsana.');
  if (reason.length < 1) return message.reply('Niye kickliycem yazsana leeeen.').catch(console.error);
